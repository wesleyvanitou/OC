...
33
normal! zo
let s:l = 129 - ((38 * winheight(0) + 28) / 56)
...
53
normal! zo
let s:l = 60 - ((46 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
60
...
setlocal spellfile=
setlocal spelllang=en
setlocal statusline=%!py3eval('powerline.statusline(22)')
setlocal suffixesadd=.py
setlocal swapfile
setlocal synmaxcol=3000
if &syntax != 'python'
...
wincmd w
argglobal
if bufexists("pkg/sprites/guard.py") | buffer pkg/sprites/guard.py | else | edit pkg/sprites/guard.py | endif
let s:cpo_save=&cpo
set cpo&vim
noremap <buffer> <F7> :call flake8#Flake8()
let &cpo=s:cpo_save
...
set stal=1
badd +0 pkg/ui.py
badd +68 pkg/sprites/hero.py
badd +1 pkg/sprites/guard.py
badd +12 main.py
badd +32 pkg/settings/config.py
badd +1 pkg/settings/maze.py
badd +1 pkg/settings/maze.txt
