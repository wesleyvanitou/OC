...
42
normal! zo
let s:l = 38 - ((31 * winheight(0) + 24) / 49)
...
wincmd w
argglobal
if bufexists("pkg/ui.py") | buffer pkg/ui.py | else | edit pkg/ui.py | endif
let s:cpo_save=&cpo
set cpo&vim
noremap <buffer> <F7> :call flake8#Flake8()
let &cpo=s:cpo_save
...
33
normal! zo
let s:l = 80 - ((30 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
80
...
wincmd w
argglobal
if bufexists("pkg/items.py") | buffer pkg/items.py | else | edit pkg/items.py | endif
let s:cpo_save=&cpo
set cpo&vim
noremap <buffer> <F7> :call flake8#Flake8()
let &cpo=s:cpo_save
...
setlocal spellfile=
setlocal spelllang=en
setlocal statusline=%!py3eval('powerline.statusline(41)')
setlocal suffixesadd=.py
setlocal swapfile
setlocal synmaxcol=3000
if &syntax != 'python'
...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 47 + 26) / 52)
exe 'vert 1resize ' . ((&columns * 31 + 119) / 239)
exe '2resize ' . ((&lines * 47 + 26) / 52)
...
set stal=1
badd +24 main.py
badd +1 pkg/assets.py
badd +1 pkg/hero.py
badd +80 pkg/ui.py
badd +58 pkg/maze.py
badd +1 :w
badd +1 pkg/__init__.py
badd +29 pkg/guard.py
badd +2 pkg/items.py
badd +12 pkg/settings.py
